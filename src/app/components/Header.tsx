...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-sm shadow-sm w-full transition-colors">
                            ...
                            <>
                                <Link
                                    ...
                                    className={`hover:text-indigo-600 transition-colors ${
                                        pathname === '/insideout' ? 'text-indigo-600' : 'text-gray-700'
                                    }`}
                                >
                                    모임
                                </Link>
                                <Link
                                    href="/about"
                                    className={`hover:text-indigo-600 transition-colors ${
                                        pathname === '/about' ? 'text-indigo-600' : 'text-gray-700'
                                    }`}
                                >
                                    소개
                                </Link>
            ...
            {/* 모바일 메뉴 */}
            <div
                className={`md:hidden fixed top-20 left-0 w-full bg-white border-t border-gray-200 shadow-md transition-transform duration-300 ease-in-out ${

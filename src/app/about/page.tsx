...
function IntroSection() {
    return (
        <section className="space-y-20">
            {/* Hero Banner */}
            <section className="text-center bg-indigo-500 text-white rounded-xl p-12 space-y-4 shadow-lg">
                <h1 className="text-4xl sm:text-5xl font-extrabold flex flex-col gap-3">
                    <span>&apos;나&apos;로부터 출발해서</span>
                    <span>&apos;함께&apos; 확장해요.</span>
                </h1>
                <p className="text-lg sm:text-xl font-medium">
                    인사이드아웃은 청년 대상 커뮤니티 플랫폼으로, 모임과 강연,
                    성장 프로그램을 제공합니다.
                </p>
            </section>
            ...
            <section className="space-y-16">
                ...
                />
                <IntroCard
                    image="https://imagedelivery.net/BeIKmnUeqh2uGk7c6NSanA/135c62dd-65eb-4dc2-360d-298505011200/public"
                    title="혼자라면 놓쳤을 경험"
                    description="함께 모임과 대화를 통해 시야를 넓히고, 새로운 인사이트와 교류를 경험할 수 있습니다."
                    reverse
                />
                <IntroCard
                    image="https://imagedelivery.net/BeIKmnUeqh2uGk7c6NSanA/8858f63c-0a7c-4b49-8e01-31349e466000/public"
            ...
            {/* <section className="bg-orange-50 p-12 rounded-xl text-center space-y-6">
                ...
                <p className="text-gray-700 max-w-2xl mx-auto">
                    그룹 코칭 기반 자기 성장 프로그램으로, 20~30대 청년들이 자기
                    인식과 가치 발견, 성장 경험을 누릴 수 있도록 설계되었습니다.
                </p>
            </section> */}
        </section>
    );
        ...
        <section className="py-20 bg-gradient-to-b from-white to-indigo-50">
            ...
            <div className="text-center mb-14">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                    멤버십에 가입하면{" "}
                    <strong className="text-indigo-600">인사이드</strong>와{" "}
                    <strong className="text-orange-500">아웃</strong> 두 가지
                    디벨롭 혜택을 함께 누릴 수 있습니다.
                </p>
            </div>
            ...
            <div className="text-center mt-16">
                ...
                <p className="text-gray-500 text-sm mt-3">
                    지금 가입하면 첫 달{" "}
                    <strong className="text-indigo-600">10% 할인</strong> 혜택
                    제공 🎉
                </p>
            </div>
        </section>
    ...
    return (
        ...
        >
            <img
                src={image}
                alt={title}
                className="w-full md:w-1/2 rounded-xl shadow-md object-cover aspect-5/3"
            />
